...
float UPlayerStatusComponent::F_GetExpMax()
{
	return m_fExpMax;
}

float UPlayerStatusComponent::F_GetExpCurrent()
{
	return m_fExpCurrent;
}

float UPlayerStatusComponent::F_GetExpNormalized()
{
	return m_fExpNormalized;
}

uint8 UPlayerStatusComponent::F_GetStrength()
{
	return m_nStrength;
}

uint8 UPlayerStatusComponent::F_GetAgility()
{
	return m_nAgility;
}

uint8 UPlayerStatusComponent::F_GetConstitution()
{
	return m_nConstitution;
}

uint8 UPlayerStatusComponent::F_GetIntelligence()
{
	return m_nIntelligence;
}

uint8 UPlayerStatusComponent::F_GetSkillPoint()
{
	return m_nSkillPoint;
}

uint8 UPlayerStatusComponent::F_GetStatusPoint()
{
	return m_nStatusPoint;
}
